...
from app.polin_variance_functions import polynomial
from app.tsqm_functions import form_matrix_A, form_vector_b, gauss_solve, normalize_x
...
def main():
    ...
    plot_prognose(x_future, y_future, x, y, m)
